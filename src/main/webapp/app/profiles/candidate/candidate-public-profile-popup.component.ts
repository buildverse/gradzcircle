...
export class CandidatePublicProfilePopupDialogComponent implements OnInit, OnDestroy {
    ...
    save() {
        ...
        this.subscribeToSaveResponse(
            this.candidateService.linkCandidateAndCorporateForJob(this.candidate.candidateDetails.id, this.jobId, this.corporateId)
        );
    }

    private subscribeToSaveResponse(result: Observable<HttpResponse<Candidate>>) {
        this.eventSubscriber = result.subscribe(
            (res: HttpResponse<Candidate>) => this.onSaveSuccess(res.body),
