...
export class CandidatePublicProfilePopupService {
  ...
  open(component: Component, id?: number | any, jobId?: number, corporateId?: number, fromLinkedCandidate?: boolean): Promise<NgbModalRef> {
  ...
  candidateModalRef(component: Component, candidate: CandidatePublicProfile, jobId?: number, corporateId?: number, fromLinkedCandidate?: boolean): NgbModalRef {
