...
export class CaptureCollegeService {
    ...
    create(captureCollege: CaptureCollege): Observable<CaptureCollege> {
    ...
    update(captureCollege: CaptureCollege): Observable<CaptureCollege> {
        const copy = this.convert(captureCollege);
    ...
    find(id: number): Observable<CaptureCollege> {
     ...
     */
    private convertItemFromServer(json: any): CaptureCollege {
        const entity: CaptureCollege = Object.assign(new CaptureCollege(), json);
        return entity;
    }
