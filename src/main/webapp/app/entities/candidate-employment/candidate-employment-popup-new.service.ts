...
export class CandidateEmploymentPopupServiceNew {
    ...
    open(component: Component, id?: number | any, fromProfile?: boolean): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            setTimeout(() => {
                this.ngbModalRef = this.candidateEducationModalRef(component, this.candidateEmployment, fromProfile);
                resolve(this.ngbModalRef);
            }, 0);
        });
    }

    candidateEducationModalRef(component: Component, candidateEmployment: CandidateEmployment, fromProfile?: boolean): NgbModalRef {
