...
export class CorporateService {
    ...
    private convert(corporate: Corporate): Corporate {
        const copy: Corporate = Object.assign({}, corporate);
        //  copy.establishedSince = this.dateUtils.convertLocalDateToServer(corporate.establishedSince.format(DATE_FORMAT));
        copy.establishedSince = corporate.establishedSince.format(DATE_FORMAT);
