...
import {ITEMS_PER_PAGE, DataService, DataStorageService, Principal} from '../../shared';
...
import { LoginEmitterService } from '../../shared/login/login-emitter.service';
...
export class JobComponentAnonymous implements OnInit, OnDestroy {
  ...
  //  console.log('canidate id is for matchScoreFrom to macthScore' + this.candidateId + ' ' + this.matchScoreFrom + ' ' + this.matchScoreTo);
    ...
    if ((this.contract && this.permanent) && !this.jobType) {
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_PART_TIME);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_INTERNSHIP, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_PART_TIME);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndTwoJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_INTERNSHIP, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_FULL_TIME,
        JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_FULL_TIME,
        JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_PART_TIME,
        JobConstants.JOB_TYPE_SUMMER_JOB, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_CONTRACT, JobConstants.JOB_TYPE_SUMMER_JOB,
        JobConstants.JOB_TYPE_INTERNSHIP, JobConstants.JOB_TYPE_FULL_TIME);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_FULL_TIME,
        JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_PART_TIME,
        JobConstants.JOB_TYPE_SUMMER_JOB, JobConstants.JOB_TYPE_INTERNSHIP);
      ...
      this.loadActiveJobsByEmploymentTypeAndThreeJobType(JobConstants.EMPLOYMENT_TYPE_PERMANENT, JobConstants.JOB_TYPE_SUMMER_JOB,
        JobConstants.JOB_TYPE_INTERNSHIP, JobConstants.JOB_TYPE_FULL_TIME);
      // Now one job type
      ...
      this.loadActiveJobsByThreeJobType(JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB);
    } else if (this.fullTime && this.partTime && this.internship && !this.summerJob) {
      //console.log('Calling for fullTime partTime internship ');
      this.loadActiveJobsByThreeJobType(JobConstants.JOB_TYPE_FULL_TIME, JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_INTERNSHIP);
    } else if (this.partTime && this.summerJob && this.internship && !this.fullTime) {
      //console.log('Calling for internship partTime summerJob ');
      this.loadActiveJobsByThreeJobType(JobConstants.JOB_TYPE_PART_TIME, JobConstants.JOB_TYPE_SUMMER_JOB, JobConstants.JOB_TYPE_INTERNSHIP);
    } else if (this.summerJob && this.internship && this.fullTime && !this.partTime) {
      //console.log('Calling for fullTime internship summerJob ');
      this.loadActiveJobsByThreeJobType(JobConstants.JOB_TYPE_SUMMER_JOB, JobConstants.JOB_TYPE_INTERNSHIP, JobConstants.JOB_TYPE_FULL_TIME);
  ...
  loadActiveJobsByEmploymentType(employmentType: string) {
    ...
    this.jobService.queryActiveJobsByEmploymentType({
      page: this.page - 1,
  ...
  loadActiveJobsByEmploymentTypeAndOneJobType(employmentType: string, jobType: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByEmploymentTypeAndOneJobType({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, employmentType, jobType, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsByEmploymentTypeAndTwoJobType(employmentType: string, jobType1: string, jobType2: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByEmploymentTypeAndTwoJobTypes({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, employmentType, jobType1, jobType2, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsByEmploymentTypeAndThreeJobType(employmentType: string, jobType1: string, jobType2: string, jobType3: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByEmploymentTypeAndThreeJobTypes({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, employmentType, jobType1, jobType2, jobType3, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsByJobType(jobType: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByOneJobType({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, jobType, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsByTwoJobType(jobType1: string, jobType2: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByTwoJobTypes({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, jobType1, jobType2, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsByThreeJobType(jobType1: string, jobType2: string, jobType3: string) {
    this.spinnerService.show();
    this.jobService.queryActiveJobsByThreeJobTypes({
      page: this.page - 1,
      query: this.currentSearch,
      size: this.itemsPerPage,
      sort: this.sort(),
    }, jobType1, jobType2, jobType3, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  loadActiveJobsForCandidate() {
   // console.log('Calling job data for candidate ');
    ...
    this.jobService.queryActiveJobsForCandidates({
      ...
      size: this.itemsPerPage,
      sort: this.sort(),
    }, this.candidateId, this.matchScoreFrom, this.matchScoreTo).subscribe(
      (res: HttpResponse<Job[]>) => this.onSuccess(res.body, res.headers),
      (res: HttpResponse<any>) => this.onError(res.body)
      );
  }
  ...
  // console.log('Registering chnage in job');
   if (this.candidateId > 0) {
      ...
      this.eventSubscriberAnonymous = this.eventManager.subscribe('jobListModification', (response) => this.loadActiveJobsByUserFilter());
    }
  }
