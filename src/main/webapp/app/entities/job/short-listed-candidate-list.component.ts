...
export class ShortListedCandidateListComponent implements OnInit, OnDestroy {
  ...
  loadShortListedCandidates() {
    this.jobService.queryShortListedCandidatesForJob({
      page: this.page - 1,
  ...
  registerChangeInShortListed() {
    this.eventSubscriber = this.eventManager.subscribe('shortListedCandidateListModification', (response) => this.loadShortListedCandidates());
  }
