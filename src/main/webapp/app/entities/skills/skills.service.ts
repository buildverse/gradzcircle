...
export class SkillsService {
    ...
    create(skills: Skills): Observable<EntityResponseType> {
        ...
        return this.http
            .post<Skills>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(skills: Skills): Observable<EntityResponseType> {
        const copy = this.convert(skills);
        return this.http
            .put<Skills>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<Skills>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<Skills[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<Skills[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Skills[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<Skills[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<Skills[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Skills[]>) => this.convertArrayResponse(res)));
    }
