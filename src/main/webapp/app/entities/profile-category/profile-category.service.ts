...
export class ProfileCategoryService {
    ...
    create(profileCategory: ProfileCategory): Observable<EntityResponseType> {
        ...
        return this.http
            .post<ProfileCategory>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(profileCategory: ProfileCategory): Observable<EntityResponseType> {
        const copy = this.convert(profileCategory);
        return this.http
            .put<ProfileCategory>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<ProfileCategory>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<ProfileCategory[]>> {
        ...
        return this.http
            .get<ProfileCategory[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<ProfileCategory[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<ProfileCategory[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<ProfileCategory[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<ProfileCategory[]>) => this.convertArrayResponse(res)));
    }
