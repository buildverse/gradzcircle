...
export class GenderService {
    ...
    create(gender: Gender): Observable<EntityResponseType> {
        ...
        return this.http
            .post<Gender>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(gender: Gender): Observable<EntityResponseType> {
        const copy = this.convert(gender);
        return this.http
            .put<Gender>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<Gender>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<Gender[]>> {
        ...
        return this.http
            .get<Gender[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Gender[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<Gender[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<Gender[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Gender[]>) => this.convertArrayResponse(res)));
    }
