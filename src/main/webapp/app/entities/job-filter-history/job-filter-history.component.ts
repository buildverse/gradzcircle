...
jobFilterHistories: JobFilterHistory[];
    ...
    loadAll() {
        if (this.currentSearch) {
            this.jobFilterHistoryService.search({
                query: this.currentSearch,
                    ...
                    (res: ResponseWrapper) => this.jobFilterHistories = res.json,
        ...
        this.jobFilterHistoryService.query().subscribe(
            (res: ResponseWrapper) => {
                this.jobFilterHistories = res.json;
                this.currentSearch = '';
              console.log('job filer hist is '+JSON.stringify(this.jobFilterHistories));
            },
            (res: ResponseWrapper) => this.onError(res.json)
        );
    }
