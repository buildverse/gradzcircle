...
export class CaptureQualificationService {
    ...
    create(captureQualification: CaptureQualification): Observable<EntityResponseType> {
        ...
        return this.http
            .post<CaptureQualification>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(captureQualification: CaptureQualification): Observable<EntityResponseType> {
        const copy = this.convert(captureQualification);
        return this.http
            .put<CaptureQualification>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<CaptureQualification>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<CaptureQualification[]>> {
        ...
        return this.http
            .get<CaptureQualification[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<CaptureQualification[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<CaptureQualification[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<CaptureQualification[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<CaptureQualification[]>) => this.convertArrayResponse(res)));
    }
