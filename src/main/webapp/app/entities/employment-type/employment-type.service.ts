...
export class EmploymentTypeService {
    ...
    create(employmentType: EmploymentType): Observable<EmploymentType> {
    ...
    update(employmentType: EmploymentType): Observable<EmploymentType> {
        const copy = this.convert(employmentType);
    ...
    find(id: number): Observable<EmploymentType> {
     ...
     */
    private convertItemFromServer(json: any): EmploymentType {
        const entity: EmploymentType = Object.assign(new EmploymentType(), json);
        return entity;
    }
