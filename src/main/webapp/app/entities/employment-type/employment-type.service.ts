...
export class EmploymentTypeService {
    ...
    create(employmentType: EmploymentType): Observable<EntityResponseType> {
        ...
        return this.http
            .post<EmploymentType>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(employmentType: EmploymentType): Observable<EntityResponseType> {
        const copy = this.convert(employmentType);
        return this.http
            .put<EmploymentType>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<EmploymentType>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<EmploymentType[]>> {
        ...
        return this.http
            .get<EmploymentType[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<EmploymentType[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<EmploymentType[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<EmploymentType[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<EmploymentType[]>) => this.convertArrayResponse(res)));
    }
