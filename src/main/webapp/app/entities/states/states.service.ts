...
export class StatesService {
    ...
    create(states: States): Observable<EntityResponseType> {
        ...
        return this.http
            .post<States>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(states: States): Observable<EntityResponseType> {
        const copy = this.convert(states);
        return this.http
            .put<States>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<States>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<States[]>> {
        ...
        return this.http
            .get<States[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<States[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<States[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<States[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<States[]>) => this.convertArrayResponse(res)));
    }
