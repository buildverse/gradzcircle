...
export class CandidateEducationDialogComponent implements OnInit {
    ...
    isQualificationOther(event) {
        ...
        if (this.candidateEducation.qualification) {
            let qualifcation = this.candidateEducation.qualification as Qualification;
            if (qualifcation.qualification === 'Other')
    ...
    isCourseOther(event) {
        ...
        if (this.candidateEducation.course) {
            let course = this.candidateEducation.course as Course;
            if (course.course === 'Other')
                this.showCourseTextArea = true;
        }
    }

    isCollegeOther(event) {
        this.showCollegeTextArea = false;
        if (this.candidateEducation.college) {
            let college = this.candidateEducation.college as College;
            if (college.collegeName === 'Other')
