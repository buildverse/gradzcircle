...
export class CandidateEducationService {
    ...
    private convertItemFromServer(candidateEducation: CandidateEducation): CandidateEducation {
        ...
        if (candidateEducation.educationFromDate) {
            copy.educationFromDate = moment(candidateEducation.educationFromDate);
        }
        if (candidateEducation.educationToDate) {
            copy.educationToDate = moment(candidateEducation.educationToDate);
        }
    ...
    private convert(candidateEducation: CandidateEducation): CandidateEducation {
        const copy: CandidateEducation = Object.assign({}, candidateEducation);
        if (candidateEducation.educationFromDate) {
            copy.educationFromDate = candidateEducation.educationFromDate.format(DATE_FORMAT);
        }
        if (candidateEducation.educationToDate) {
            copy.educationToDate = candidateEducation.educationToDate.format(DATE_FORMAT);
        }
