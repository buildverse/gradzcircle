...
export class AddressService {
    ...
    create(address: Address): Observable<EntityResponseType> {
        ...
        return this.http
            .post<Address>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(address: Address): Observable<EntityResponseType> {
        const copy = this.convert(address);
        return this.http
            .put<Address>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<Address>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertResponse(res)));
    }
    ...
    query(req?: any): Observable<HttpResponse<Address[]>> {
        ...
        return this.http
            .get<Address[]>(this.resourceUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Address[]>) => this.convertArrayResponse(res)));
    }
    ...
    search(req?: any): Observable<HttpResponse<Address[]>> {
        const options = createRequestOption(req);
        return this.http
            .get<Address[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .pipe(map((res: HttpResponse<Address[]>) => this.convertArrayResponse(res)));
    }
