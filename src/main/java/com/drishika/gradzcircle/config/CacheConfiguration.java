...
public class CacheConfiguration {
	...
	public JCacheManagerCustomizer cacheManagerCustomizer() {
		return cm -> {
			...
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".educations",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".nonAcademics",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".certifications",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".employments",
					jcacheConfiguration);
			cm.createCache(
					com.drishika.gradzcircle.domain.Candidate.class.getName() + ".candidateLanguageProficiencies",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".jobCategories",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.CandidateEducation.class.getName() + ".projects",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.CandidateEmployment.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.CandidateEmployment.class.getName() + ".projects",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.CandidateNonAcademicWork.class.getName(),
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.CandidateProject.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.CandidateLanguageProficiency.class.getName(),
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.VisaType.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.VisaType.class.getName() + ".candidates",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.EmploymentType.class.getName() + ".candidateEmployments",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Qualification.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Qualification.class.getName() + ".candidateEducations",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Course.class.getName() + ".candidateEducations",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Country.class.getName() + ".universities",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Country.class.getName() + ".candidateEmployments",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Country.class.getName() + ".visas", jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Country.class.getName() + ".corporates",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Industry.class.getName() + ".corporates",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.JobType.class.getName() + ".candidateEmployments",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.College.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.College.class.getName() + ".candidateEducations",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.University.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.University.class.getName() + ".colleges",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.JobCategory.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.JobCategory.class.getName() + ".candidates",
					jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Language.class.getName(), jcacheConfiguration);
			cm.createCache(com.drishika.gradzcircle.domain.Language.class.getName() + ".candidateLanguageProficiencies",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".addresses",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Job.class.getName() + ".appliedCandidates",
					jcacheConfiguration);
			...
			// cm.createCache(com.drishika.gradzcircle.domain.FilterCategory.class.getName(),
			// jcacheConfiguration);
			// cm.createCache(com.drishika.gradzcircle.domain.FilterCategory.class.getName()
			// + ".filters", jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.JobFilter.class.getName() + ".histories",
					jcacheConfiguration);
			...
			cm.createCache(com.drishika.gradzcircle.domain.Candidate.class.getName() + ".appliedJobs",
					jcacheConfiguration);
