...
public class CandidateEmployment implements Serializable {
	...
	public String toString() {
		return "CandidateEmployment{" + "id=" + getId() + ", location='" + getLocation() + "'" + ", jobTitle='"
				+ getJobTitle() + "'" + ", employerName='" + getEmployerName() + "'" + ", employmentStartDate='"
				+ getEmploymentStartDate() + "'" + ", employmentEndDate='" + getEmploymentEndDate() + "'"
				+ ", employmentDuration='" + getEmploymentDuration() + "'" + ", isCurrentEmployment='"
				+ isIsCurrentEmployment() + "'" + ", jobDescription='" + getJobDescription() + "'" + "}";
	}
}
