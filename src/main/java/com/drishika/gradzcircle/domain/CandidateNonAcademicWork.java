...
public class CandidateNonAcademicWork implements Serializable {
	...
	public String toString() {
		return "CandidateNonAcademicWork{" + "id=" + getId() + ", nonAcademicInitiativeTitle='"
				+ getNonAcademicInitiativeTitle() + "'" + ", nonAcademicInitiativeDescription='"
				+ getNonAcademicInitiativeDescription() + "'" + ", duration='" + getDuration() + "'"
				+ ", isCurrentActivity='" + isIsCurrentActivity() + "'" + ", roleInInitiative='" + getRoleInInitiative()
