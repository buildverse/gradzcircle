...
public class Employability implements Serializable {
	...
	public String toString() {
		return "Employability{" + "id=" + getId() + ", employableSkillName='" + getEmployableSkillName() + "'"
				+ ", employabilityScore='" + getEmployabilityScore() + "'" + ", employabilityPercentile='"
				+ getEmployabilityPercentile() + "'" + "}";
	}
}
