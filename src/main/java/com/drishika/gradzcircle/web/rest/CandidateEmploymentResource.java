...
public class CandidateEmploymentResource {
     ...
     *
     * @param candidateEmployment the candidateEmployment to create
     * @return the ResponseEntity with status 201 (Created) and with body the new candidateEmployment, or with status 400 (Bad Request) if the candidateEmployment has already an ID
     ...
     *
     * @param candidateEmployment the candidateEmployment to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated candidateEmployment,
     * or with status 400 (Bad Request) if the candidateEmployment is not valid,
     * or with status 500 (Internal Server Error) if the candidateEmployment couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/candidate-employments")
    @Timed
    public ResponseEntity<CandidateEmployment> updateCandidateEmployment(@RequestBody CandidateEmployment candidateEmployment) throws URISyntaxException {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of candidateEmployments in body
     */
    ...
    */
     ...
     *
     * @param id the id of the candidateEmployment to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the candidateEmployment, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the candidateEmployment to delete
    ...
    /**
     * SEARCH  /_search/candidate-employments?query=:query : search for the candidateEmployment corresponding
     * to the query.
     *
     * @param query the query of the candidateEmployment search
