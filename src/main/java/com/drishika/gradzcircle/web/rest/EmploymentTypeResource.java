...
public class EmploymentTypeResource {
	...
	public EmploymentTypeResource(EmploymentTypeRepository employmentTypeRepository,
	 ...
	 *            the employmentType to create
	 * @return the ResponseEntity with status 201 (Created) and with body the new
	 *         employmentType, or with status 400 (Bad Request) if the
	 *         employmentType has already an ID
	...
	public ResponseEntity<EmploymentType> createEmploymentType(@RequestBody EmploymentType employmentType)
		...
		if (employmentType.getId() != null) {
			return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists",
					"A new employmentType cannot already have an ID")).body(null);
		}
	 ...
	 *
	 * @param employmentType
	 *            the employmentType to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         employmentType, or with status 400 (Bad Request) if the
	 *         employmentType is not valid, or with status 500 (Internal Server
	 *         Error) if the employmentType couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/employment-types")
	@Timed
	public ResponseEntity<EmploymentType> updateEmploymentType(@RequestBody EmploymentType employmentType)
			throws URISyntaxException {
	 ...
	 *
	 * @param id
	 *            the id of the employmentType to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         employmentType, or with status 404 (Not Found)
	 */
	 ...
	 *
	 * @param id
	 *            the id of the employmentType to delete
	...
	/**
	 * SEARCH /_search/employment-types?query=:query : search for the employmentType
	 * corresponding to the query.
	 *
	 * @param query
	 *            the query of the employmentType search
	...
	public List<EmploymentType> searchEmploymentTypes(@RequestParam String query) {
		...
		return StreamSupport.stream(employmentTypeSearchRepository.search(queryStringQuery(query)).spliterator(), false)
