...
public class CaptureUniversityResource {
    ...
    public CaptureUniversityResource(CaptureUniversityRepository captureUniversityRepository, CaptureUniversitySearchRepository captureUniversitySearchRepository) {
     ...
     *
     * @param captureUniversity the captureUniversity to create
     * @return the ResponseEntity with status 201 (Created) and with body the new captureUniversity, or with status 400 (Bad Request) if the captureUniversity has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/capture-universities")
    @Timed
    public ResponseEntity<CaptureUniversity> createCaptureUniversity(@RequestBody CaptureUniversity captureUniversity) throws URISyntaxException {
        log.debug("REST request to save CaptureUniversity : {}", captureUniversity);
        if (captureUniversity.getId() != null) {
            throw new BadRequestAlertException("A new captureUniversity cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     *
     * @param captureUniversity the captureUniversity to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated captureUniversity,
     * or with status 400 (Bad Request) if the captureUniversity is not valid,
     * or with status 500 (Internal Server Error) if the captureUniversity couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/capture-universities")
    @Timed
    public ResponseEntity<CaptureUniversity> updateCaptureUniversity(@RequestBody CaptureUniversity captureUniversity) throws URISyntaxException {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of captureUniversities in body
     */
     ...
     *
     * @param id the id of the captureUniversity to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the captureUniversity, or with status 404 (Not Found)
     */
    ...
    public ResponseEntity<CaptureUniversity> getCaptureUniversity(@PathVariable Long id) {
        ...
        Optional<CaptureUniversity> captureUniversity = captureUniversityRepository.findById(id);
        return ResponseUtil.wrapOrNotFound(captureUniversity);
    }

    /**
     * DELETE  /capture-universities/:id : delete the "id" captureUniversity.
     *
     * @param id the id of the captureUniversity to delete
    ...
    public ResponseEntity<Void> deleteCaptureUniversity(@PathVariable Long id) {
        ...
        captureUniversityRepository.deleteById(id);
        captureUniversitySearchRepository.deleteById(id);
        return ResponseEntity.ok().headers(HeaderUtil.createEntityDeletionAlert(ENTITY_NAME, id.toString())).build();
    }

    /**
     * SEARCH  /_search/capture-universities?query=:query : search for the captureUniversity corresponding
     * to the query.
     *
     * @param query the query of the captureUniversity search
