...
public class CandidateCertificationResource {
    ...
    public CandidateCertificationResource(CandidateCertificationRepository candidateCertificationRepository, CandidateCertificationSearchRepository candidateCertificationSearchRepository) {
     ...
     *
     * @param candidateCertification the candidateCertification to create
     * @return the ResponseEntity with status 201 (Created) and with body the new candidateCertification, or with status 400 (Bad Request) if the candidateCertification has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/candidate-certifications")
    @Timed
    public ResponseEntity<CandidateCertification> createCandidateCertification(@RequestBody CandidateCertification candidateCertification) throws URISyntaxException {
        log.debug("REST request to save CandidateCertification : {}", candidateCertification);
        if (candidateCertification.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new candidateCertification cannot already have an ID")).body(null);
        }
     ...
     *
     * @param candidateCertification the candidateCertification to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated candidateCertification,
     * or with status 400 (Bad Request) if the candidateCertification is not valid,
     * or with status 500 (Internal Server Error) if the candidateCertification couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/candidate-certifications")
    @Timed
    public ResponseEntity<CandidateCertification> updateCandidateCertification(@RequestBody CandidateCertification candidateCertification) throws URISyntaxException {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of candidateCertifications in body
     */
    ...
    public List<CandidateCertification> getCertificationByCandidate(@PathVariable Long id) {
        ...
        List<CandidateCertification> candidateCertifications = candidateCertificationRepository.findCertificationsByCandidateId(id);
        candidateCertifications.forEach(candidateCertification->candidateCertification.setCandidate(null));
        return candidateCertifications;
    }

    /**
     * DELETE  /candidate-certifications/:id : delete the "id" candidateCertification.
     *
     * @param id the id of the candidateCertification to delete
    ...
    /**
     * SEARCH  /_search/candidate-certifications?query=:query : search for the candidateCertification corresponding
     * to the query.
     *
     * @param query the query of the candidateCertification search
