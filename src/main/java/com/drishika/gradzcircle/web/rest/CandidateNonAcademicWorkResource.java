...
public class CandidateNonAcademicWorkResource {
    ...
    public CandidateNonAcademicWorkResource(CandidateNonAcademicWorkRepository candidateNonAcademicWorkRepository, CandidateNonAcademicWorkSearchRepository candidateNonAcademicWorkSearchRepository) {
     ...
     *
     * @param candidateNonAcademicWork the candidateNonAcademicWork to create
     * @return the ResponseEntity with status 201 (Created) and with body the new candidateNonAcademicWork, or with status 400 (Bad Request) if the candidateNonAcademicWork has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/candidate-non-academic-works")
    @Timed
    public ResponseEntity<CandidateNonAcademicWork> createCandidateNonAcademicWork(@RequestBody CandidateNonAcademicWork candidateNonAcademicWork) throws URISyntaxException {
        log.debug("REST request to save CandidateNonAcademicWork : {}", candidateNonAcademicWork);
        if (candidateNonAcademicWork.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new candidateNonAcademicWork cannot already have an ID")).body(null);
        }
    ...
    /**
     * PUT  /candidate-non-academic-works : Updates an existing candidateNonAcademicWork.
     *
     * @param candidateNonAcademicWork the candidateNonAcademicWork to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated candidateNonAcademicWork,
     * or with status 400 (Bad Request) if the candidateNonAcademicWork is not valid,
     * or with status 500 (Internal Server Error) if the candidateNonAcademicWork couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/candidate-non-academic-works")
    @Timed
    public ResponseEntity<CandidateNonAcademicWork> updateCandidateNonAcademicWork(@RequestBody CandidateNonAcademicWork candidateNonAcademicWork) throws URISyntaxException {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of candidateNonAcademicWorks in body
     */
    ...
    /**
     * GET  /candidate-non-academic-works/:id : get the "id" candidateNonAcademicWork.
     *
     * @param id the id of the candidateNonAcademicWork to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the candidateNonAcademicWork, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /candidate-non-academic-works/:id : delete the "id" candidateNonAcademicWork.
     *
     * @param id the id of the candidateNonAcademicWork to delete
    ...
    *
    * @param id the id of the candidateCertification to retrieve
    * @return the ResponseEntity with status 200 (OK) and with body the candidateCertification, or with status 404 (Not Found)
    */
   ...
   public List<CandidateNonAcademicWork> getCertificationByCandidate(@PathVariable Long id) {
       ...
       List<CandidateNonAcademicWork> candidateNonAcademicWorks = candidateNonAcademicWorkRepository.findNonAcademicWorkByCandidateId(id);
    ...
    /**
     * SEARCH  /_search/candidate-non-academic-works?query=:query : search for the candidateNonAcademicWork corresponding
     * to the query.
     *
     * @param query the query of the candidateNonAcademicWork search
