...
public class ElasticsearchIndexService {
    ...
    public ElasticsearchIndexService(
        ...
        AuditSearchRepository auditSearchRepository,
        ...
        CorporateSearchRepository corporateSearchRepository,
        ...
        GenderSearchRepository genderSearchRepository,
        IndustryRepository industryRepository,
        IndustrySearchRepository industrySearchRepository,
        JobCategoryRepository jobCategoryRepository,
        JobCategorySearchRepository jobCategorySearchRepository,
        JobTypeRepository jobTypeRepository,
        JobTypeSearchRepository jobTypeSearchRepository,
        ...
        QualificationSearchRepository qualificationSearchRepository,
        SkillsRepository skillsRepository,
        SkillsSearchRepository skillsSearchRepository,
        UniversityRepository universityRepository,
        UniversitySearchRepository universitySearchRepository,
        VisaTypeRepository visaTypeRepository,
        VisaTypeSearchRepository visaTypeSearchRepository,
    ...
    public void reindexAll() {
        ...
        reindexForClass(Candidate.class, candidateRepository, candidateSearchRepository);
        reindexForClass(CandidateCertification.class, candidateCertificationRepository, candidateCertificationSearchRepository);
        reindexForClass(CandidateEducation.class, candidateEducationRepository, candidateEducationSearchRepository);
        reindexForClass(CandidateEmployment.class, candidateEmploymentRepository, candidateEmploymentSearchRepository);
        reindexForClass(CandidateLanguageProficiency.class, candidateLanguageProficiencyRepository, candidateLanguageProficiencySearchRepository);
        reindexForClass(CandidateNonAcademicWork.class, candidateNonAcademicWorkRepository, candidateNonAcademicWorkSearchRepository);
        reindexForClass(CandidateProject.class, candidateProjectRepository, candidateProjectSearchRepository);
        reindexForClass(CaptureCollege.class, captureCollegeRepository, captureCollegeSearchRepository);
