...
public class UserService {
    ...
    SocialService socialService, UserSearchRepository userSearchRepository, AuthorityRepository authorityRepository,
    ...
    private void userExtensionCreator(String corporateName,String phoneNumber,String country, String authority,User user){
        if((AuthoritiesConstants.CANDIDATE).equals(authority)){
            candidateService.createCandidate(user);
        } else if ((AuthoritiesConstants.CORPORATE).equals(authority)){
            corporateService.createCorporate(corporateName, phoneNumber, country, user);
