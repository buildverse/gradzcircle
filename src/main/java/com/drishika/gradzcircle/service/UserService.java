...
public class UserService {
    ...
    public User registerUser(String login, String password, String firstName, String lastName, String email,
		...
		Optional<Authority> authority = authorityRepository.findById(incomingAuthorities.stream().findFirst().orElse(null));
		Set<Authority> authorities = new HashSet<>();
		String encryptedPassword = passwordEncoder.encode(password);
    ...
    private void userExtensionCreator(String corporateName, String phoneNumber, String country, String authority,
			User user) {
