...
public class CaptureCollegeResourceIntTest {
    ...
    public static CaptureCollege createEntity(EntityManager em) {
        CaptureCollege captureCollege = new CaptureCollege()
    ...
    public void createCaptureCollege() throws Exception {
        ...
        restCaptureCollegeMockMvc.perform(post("/api/capture-colleges")
    ...
    public void getAllCaptureColleges() throws Exception {
        ...
        restCaptureCollegeMockMvc.perform(get("/api/capture-colleges?sort=id,desc"))
    ...
    public void updateCaptureCollege() throws Exception {
        ...
        restCaptureCollegeMockMvc.perform(put("/api/capture-colleges")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedCaptureCollege)))
            .andExpect(status().isOk());
    ...
    public void deleteCaptureCollege() throws Exception {
        ...
        // Get the captureCollege
        restCaptureCollegeMockMvc.perform(delete("/api/capture-colleges/{id}", captureCollege.getId())
