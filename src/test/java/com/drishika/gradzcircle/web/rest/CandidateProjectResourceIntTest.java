...
public class CandidateProjectResourceIntTest {
    ...
    public void setup() {
        ...
        final CandidateProjectResource candidateProjectResource = new CandidateProjectResource(candidateProjectRepository, candidateProjectSearchRepository);
    ...
    public void createCandidateProject() throws Exception {
        ...
        restCandidateProjectMockMvc.perform(post("/api/candidate-projects")
    ...
    public void getAllCandidateProjects() throws Exception {
        ...
        restCandidateProjectMockMvc.perform(get("/api/candidate-projects?sort=id,desc"))
    ...
    public void updateCandidateProject() throws Exception {
        ...
        restCandidateProjectMockMvc.perform(put("/api/candidate-projects")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    public void deleteCandidateProject() throws Exception {
        ...
        // Get the candidateProject
        restCandidateProjectMockMvc.perform(delete("/api/candidate-projects/{id}", candidateProject.getId())
