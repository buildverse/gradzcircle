...
public class CandidateCertificationResourceIntTest {
    ...
    public void setup() {
        ...
        final CandidateCertificationResource candidateCertificationResource = new CandidateCertificationResource(candidateCertificationRepository, candidateCertificationSearchRepository);
    ...
    public void createCandidateCertification() throws Exception {
        ...
        restCandidateCertificationMockMvc.perform(post("/api/candidate-certifications")
        ...
        CandidateCertification testCandidateCertification = candidateCertificationList.get(candidateCertificationList.size() - 1);
        ...
        CandidateCertification candidateCertificationEs = candidateCertificationSearchRepository.findOne(testCandidateCertification.getId());
    ...
    public void getAllCandidateCertifications() throws Exception {
        ...
        restCandidateCertificationMockMvc.perform(get("/api/candidate-certifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].certificationDetails").value(hasItem(DEFAULT_CERTIFICATION_DETAILS.toString())));
    }
    ...
    public void getCandidateCertification() throws Exception {
        ...
        restCandidateCertificationMockMvc.perform(get("/api/candidate-certifications/{id}", candidateCertification.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void updateCandidateCertification() throws Exception {
        ...
        CandidateCertification updatedCandidateCertification = candidateCertificationRepository.findOne(candidateCertification.getId());
        updatedCandidateCertification
            .certificationTitle(UPDATED_CERTIFICATION_TITLE)
            .certificationDate(UPDATED_CERTIFICATION_DATE)
            .certificationDetails(UPDATED_CERTIFICATION_DETAILS);

        restCandidateCertificationMockMvc.perform(put("/api/candidate-certifications")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    public void deleteCandidateCertification() throws Exception {
        ...
        // Get the candidateCertification
        restCandidateCertificationMockMvc.perform(delete("/api/candidate-certifications/{id}", candidateCertification.getId())
            .accept(TestUtil.APPLICATION_JSON_UTF8))
            .andExpect(status().isOk());

        // Validate Elasticsearch is empty
        boolean candidateCertificationExistsInEs = candidateCertificationSearchRepository.exists(candidateCertification.getId());
    ...
    public void searchCandidateCertification() throws Exception {
        ...
        restCandidateCertificationMockMvc.perform(get("/api/_search/candidate-certifications?query=id:" + candidateCertification.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(candidateCertification.getId().intValue())))
            .andExpect(jsonPath("$.[*].certificationTitle").value(hasItem(DEFAULT_CERTIFICATION_TITLE.toString())))
