...
public class CountryResourceIntTest {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country()
            ...
            .shortCodeThreeChar(DEFAULT_SHORT_CODE_THREE_CHAR)
            .countryNiceName(DEFAULT_COUNTRY_NICE_NAME)
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].shortCodeThreeChar").value(hasItem(DEFAULT_SHORT_CODE_THREE_CHAR.toString())))
    ...
    public void updateCountry() throws Exception {
        ...
        updatedCountry
            ...
            .shortCodeThreeChar(UPDATED_SHORT_CODE_THREE_CHAR)
            .countryNiceName(UPDATED_COUNTRY_NICE_NAME)
