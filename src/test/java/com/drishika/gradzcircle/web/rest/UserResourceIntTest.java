...
import com.drishika.gradzcircle.service.mapper.UserMapper;
...
public class UserResourceIntTest {
	...
	public static Corporate createCorporate(EntityManager em) {
		...
		corporate.setLogin(createEntity(em));
		return corporate;
	}
	...
	public static Candidate createCandidate(EntityManager em) {
		...
		candidate.setLogin(createEntity(em));
		return candidate;
	}
	...
	public void createUserWithExistingLogin() throws Exception {
		...
		ManagedUserVM managedUserVM = new ManagedUserVM(null, DEFAULT_LOGIN, // this login should already be used
				...
				DEFAULT_LANGKEY, null, null, null, null, authorities, null, null, null);
	...
	public void createUserWithExistingEmail() throws Exception {
		...
		ManagedUserVM managedUserVM = new ManagedUserVM(null, "anotherlogin", DEFAULT_PASSWORD, DEFAULT_FIRSTNAME,
				...
				true, DEFAULT_IMAGEURL, DEFAULT_LANGKEY, null, null, null, null, authorities, null, null, null);
	...
	public void updateUser() throws Exception {
		...
		ManagedUserVM managedUserVM = new ManagedUserVM(updatedUser.getId(), updatedUser.getLogin(), UPDATED_PASSWORD,
				...
				updatedUser.getLastModifiedBy(), updatedUser.getLastModifiedDate(), authorities, null, null, null);
	...
	public void updateUserExistingEmail() throws Exception {
		...
		ManagedUserVM managedUserVM = new ManagedUserVM(updatedUser.getId(), updatedUser.getLogin(),
				...
				updatedUser.getLastModifiedDate(), authorities, null, null, null);
	...
	@Test
	@Transactional
	public void deleteCorporateUser() throws Exception {
		// Initialize the database
		userRepository.saveAndFlush(user);
		userSearchRepository.save(user);
		...
		List<User> userList = userRepository.findAll();
		List<Corporate> corpList = corporateRepository.findAll();
		assertThat(userList).hasSize(databaseSizeBeforeDelete - 1);
		assertThat(corpList).hasSize(corporateDatabaseSixeBeforeDelete - 1);
	}

	@Test
	@Transactional
	public void deleteCandidateUser() throws Exception {
		// Initialize the database
		userRepository.saveAndFlush(user);
		userSearchRepository.save(user);
		...
		// Validate the database is empty
		List<User> userList = userRepository.findAll();
		List<Candidate> candList = candidateRepository.findAll();
		assertThat(userList).hasSize(databaseSizeBeforeDelete - 1);
		assertThat(candList).hasSize(candidateDatabaseSixeBeforeDelete - 1);
	}
	...
	public void getAllAuthorities() throws Exception {
		restUserMockMvc
				...
				.andExpect(jsonPath("$").isArray()).andExpect(jsonPath("$")
						.value(containsInAnyOrder("ROLE_USER", "ROLE_ADMIN", "ROLE_CANDIDATE", "ROLE_CORPORATE")));
	}
