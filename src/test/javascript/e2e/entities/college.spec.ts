...
describe('College e2e test', () => {
    ...
    it('should load Colleges', () => {
        ...
        expect(collegeComponentsPage.getTitle())
            .toMatch(/gradzcircleApp.college.home.title/);
    ...
    it('should load create College dialog', () => {
        ...
        expect(collegeDialogPage.getModalTitle())
            .toMatch(/gradzcircleApp.college.home.createOrEditLabel/);
