...
import { CandidateSkillsDialogComponent } from 'app/entities/candidate-skills/candidate-skills-dialog.component';
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    providers: [CandidateService, SkillsService, CandidateSkillsService]
                })
