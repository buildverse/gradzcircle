    ...
    describe('CandidateNonAcademicWork Service', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                providers: [JhiDateUtils, CandidateNonAcademicWorkService]
            });
            injector = getTestBed();
            service = injector.get(CandidateNonAcademicWorkService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidate-non-academic-works';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CandidateNonAcademicWork', () => {
