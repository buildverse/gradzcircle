...
import { ErrorMessagesDialogComponent } from '../../../../../../main/webapp/app/entities/error-messages/error-messages-dialog.component';
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'errorMessagesListModification', content: 'OK'});
