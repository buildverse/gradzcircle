...
class CountryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Country entity")
        ...
        .repeat(2) {
            ...
            .post("/api/countries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "countryName":"SAMPLE_TEXT", "shortCode":"SAMPLE_TEXT", "shortCodeThreeChar":"SAMPLE_TEXT", "countryNiceName":"SAMPLE_TEXT", "numCode":"0", "phoneCode":"0", "enabled":null}""")).asJSON
            .check(status.is(201))
