...
/**
 * Performance test for the Corporate entity.
 */
class CorporateGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Corporate entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created corporate")
                .get("${new_corporate_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created corporate")
            .delete("${new_corporate_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
