...
/**
 * Performance test for the CandidateEmployment entity.
 */
class CandidateEmploymentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CandidateEmployment entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all candidateEmployments")
            .get("/api/candidate-employments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created candidateEmployment")
                .get("${new_candidateEmployment_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created candidateEmployment")
            .delete("${new_candidateEmployment_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
