...
/**
 * Performance test for the CandidateProject entity.
 */
class CandidateProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CandidateProject entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all candidateProjects")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created candidateProject")
                .get("${new_candidateProject_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created candidateProject")
            .delete("${new_candidateProject_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
